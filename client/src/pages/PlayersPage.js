...
class PlayersPage extends React.Component {
    ...
    updateSearchResults() {
        ...
        console.log("All Searcheed Player = ", this.state.playersResults)
        console.log("Selected Player Details = ", this.state.selectedPlayerDetails)
      })
                ...
                {this.state.selectedPlayerDetails ? <div style={{ width: '70vw', margin: '0 auto', marginTop: '2vh' }}>
                    <Card>
                        ...
                        <Row gutter='30' align='middle' justify='center'>
                            ...
                            <Row gutter='30' align='middle' justify='left'>
                                ...
                                <Col>
                                Weight: {this.state.selectedPlayerDetails.Age}
                                </Col>
                    ...
                    <Card style={{marginTop: '2vh'}}>
                        <CardBody>
                            ...
                            <h6>Rating</h6>
                            <Progress style={{ width: '20vw'}} value={this.state.selectedPlayerDetails.Rating} >{this.state.selectedPlayerDetails.BestOverallRating}</Progress>
                                ...
                                {/*TASK 32: In case the player is a GK, show a radar chart (replacing 'null' below) with the labels: Agility, Ball Control, Passing, Positioning, Stamina, Strength */}
                                    {this.state.selectedPlayerDetails.BestPosition === 'GK'? 
                                      <RadarChart
                                          ...
                                          startingAngle={0}
                                          domains={[
                                              { name: 'Penalty', domain: [0, 100], getValue: d => d.GKPenalties },
                                              ...
                                              { name: 'Reflex', domain: [0, 100], getValue: d => d.GKReflexes }
                                          ]} 
                                          width={450}
                                          height={400}
                                      /> : 
